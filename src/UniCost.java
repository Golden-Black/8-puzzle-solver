...
public class UniCost {
    public void UniCost(Node newNode, int[][] goalState) {
    ...
    public int sorting(ArrayList<Node> listings){
        ...
        for(int i = 0; i < size; i++){
            if(listings.get(i).cost < smallest){
                smallest = listings.get(i).cost;
                smallIndex = i;
            }
        }
        return smallIndex;
        ...
        public void trace(Node node){
            ...
            System.out.println("Cost: " + ufc_cost);
        }
