...
public class AStarOne {
    public void AStarOne(Node newNode, int[][] goalState){
        ...
        while (!toCheck.isEmpty()) {
            ...
            // sort to find the smallest node by cost
    ...
    public int sorting(ArrayList<Node> listings){
        ...
        for(int i = 0; i < size; i++){
            if(listings.get(i).hOne < smallest){
    ...
    public void trace(Node node) {
        ...
        System.out.println("Cost: " + a1_cost);
    }
}